...
export default function Login() {
  return (
    <div className="flex  flex-col items-center   bg-[linear-gradient(225deg,_#96E71E_0%,_#62B467_26%,_#479B8B_38%,_#2D81AF_48%,_#246EA1_60%,_#17558E_70%,_#00286E_89%,_#131B27_97%,_#141A22_100%)] h-screen w-full">
      ...
      <div className=" flex p-14 items-center ">
        <div className="bg-white/65 p-6 text-center rounded-lg w-96 max-w-full">
          <p className="text-3xl  font-bold m-2 text-darkblue ">Registrar</p>
          ...
          <div className="flex justify-between p-4 flex-wrap    ">
            <Link type="submit" href="/login">
              <Button className="bg-lightblue font-bold hover:bg-darkblue w-32">Volar</Button>
            </Link>
